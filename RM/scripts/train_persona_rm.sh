...
# torchrun --nnodes=1 --nproc_per_node=2 --master_port=20001 finetune_persona_rm.py \
#     --persona_model_checkpoint "./checkpoints/persona_encoder_decoder/final_checkpoint" \
#     --knowledge_base_path "./data/persona_knowledge" \
#     --do_train \
#     --do_eval \
#     --seed 42 \
...
#     --qlora_r 64 \
#     --qlora_modules q_proj k_proj v_proj o_proj gate_proj up_proj down_proj \
