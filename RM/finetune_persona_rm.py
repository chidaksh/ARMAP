...
from persona_models.persona_reward_model import (
    RewardConfig,
    RewardModel,
...
def train():
    ...
    if checkpoint_dir is None:
        ...
        if args.resume_from_training:
            ...
            exit(1)
    # if "vila" in args.model_name_or_path.lower():
    #     tokenizer_model_name = args.tokenizer
    # else:
    tokenizer_model_name = args.model_name_or_path
    TokenizerClass = AutoTokenizer
    # if "VILA" in tokenizer_model_name:
    #     model_name = get_model_name_from_path(args.model_name_or_path)
    #     tokenizer, model, image_processor, context_len = load_pretrained_model(args.model_name_or_path,None, model_name)
    # else:
