...
from utils_mcts import combinations
from utils_mcts import multigpu_breakpoint
import pdb
    ...
    for _ in tqdm(range(ag.rollouts), desc="Rolling out", leave=False):
        ...
        if ag.default_policy is None:
            ...
            if not node.is_terminal:
                ...
                if env.reward_func=="gt" and estimate==1.0:
                    print("Using GT for debug and found the best reward. Exit for acceleration.\n")
                    break
