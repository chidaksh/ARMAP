...
if __name__ == "__main__":
    ...
    import pdb
    pdb.set_trace()
    #input = WorkerStartSampleRequest(name="webshop-dev", index=279)
    input = WorkerStartSampleRequest(session_id=0, index=279)
    output = task_worker.task.start_sample(279, 0)
    #output = task_worker.start_sample(parameters=input)
    import pdb
    pdb.set_trace()
    """
